...
T {This is a parametric version of CSDAC which can be used in a testbench
for testing out different permutations. I couldn't find a way to
materialize a given set of parameters in a way that Magic would import,
so I also created csdac_nom.sch with fixed values.} 280 -600 0 0 0.3 0.3 {}
N 130 -360 130 -280 {
lab=vcc}
N 130 -280 130 -250 {
lab=vcc}
...
C {devices/lab_pin.sym} 1670 -130 2 0 {name=p6 sig_type=std_logic lab=Vbias}
...
C {devices/lab_pin.sym} 1430 -590 2 0 {name=p21 sig_type=std_logic lab=vcc}
C {devices/lab_pin.sym} 1610 -590 2 0 {name=p22 sig_type=std_logic lab=vcc}
C {devices/lab_pin.sym} 1670 -480 0 1 {name=p39 sig_type=std_logic lab=Vpos}
C {devices/lab_pin.sym} 1670 -440 0 1 {name=p40 sig_type=std_logic lab=Vneg}
